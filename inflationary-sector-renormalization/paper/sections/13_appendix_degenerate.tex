% Appendix D: Degenerate small-ell behavior
\section{Degenerate small-$\ell$ behavior}
...
Table~\ref{tab:degenerate_ell_sensitivity} shows the degenerate rows from
the ell sensitivity scan, and
Table~\ref{tab:degenerate_sigma_ell} shows the full sigma--ell grid including
the small-$\ell$ columns.
