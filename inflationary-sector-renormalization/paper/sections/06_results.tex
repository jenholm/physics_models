...
\input{tables/table_01_main_distribution}
...
\input{tables/table_04_stress_summary_by_sigma}
...
Table~\ref{tab:effective_coefficients} shows the aggregate coefficients
...
\input{tables/table_06_effective_coefficients}

Fig.~\ref{fig:coeff_flow} visualizes the averaging.
...
Table~\ref{tab:ell_sensitivity} and Fig.~\ref{fig:ell_sensitivity_kl} show the
evolution of ISR stability metrics across $\ell$.
...
\input{tables/table_08_ell_sensitivity}
...
\input{tables/table_09_sigma_ell_boundary}
...
\input{tables/table_10_landscape_perturbation}
