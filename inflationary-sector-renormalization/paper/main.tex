...
\input{sections/03_isr_framework}
\input{sections/04_toy_model}
...
\newpage
\appendix
\input{sections/10_appendix_simulation}
\input{sections/11_appendix_failures}
\input{sections/12_appendix_reproducibility}
\input{sections/13_appendix_degenerate}
